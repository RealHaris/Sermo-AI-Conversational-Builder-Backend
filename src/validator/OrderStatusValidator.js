...
class OrderStatusValidator {
  async createOrderStatusValidator(req, res, next) {
  ...
  async updateOrderStatusValidator(req, res, next) {
  ...
  async updateEventMappingValidator(req, res, next) {
    // create schema object for event mapping update
    const schema = Joi.object({
